...
class BaseRelationship implements Relationship, ModelObject {
    ...
    entities: Entity[] = [];
    lHConstraints: Map<Number, String> = new Map<Number, String>();
    ...
    buildFirstPassFromJson(objectAsJson: any): void {
        ...
        for (var rawLink in objectAsJson.entities) {
            ...
            this.lHConstraints.set(linkAsJson.identifier, String(linkAsJson.lookHereConstraint));
        }
